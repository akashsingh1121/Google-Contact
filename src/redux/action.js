...
export const Getdata = () =>{
    return(dispatch)=>{
        ...
        axios("https://goggle-contact-app.herokuapp.com/users").then(res=>dispatch(getdatasuccess(res.data)))
...
export const Singlegetdata = (id) =>{
    return(dispatch)=>{
        ...
        axios(`https://goggle-contact-app.herokuapp.com/users/${id}`).then(res=>dispatch(singledatasuccess(res.data)))
...
export const Deletedata = (id) =>{
    return(dispatch)=>{
        ...
        axios.delete(`https://goggle-contact-app.herokuapp.com/users/${id}`).then(res=>{
...
export const Importdata = (data) =>{
    return(dispatch)=>{
        ...
        axios.post(`https://goggle-contact-app.herokuapp.com/upload`,data,{headers}).then(res=>{
...
export const Exportdata = () =>{
    return(dispatch)=>{
        ...
        axios.get("https://goggle-contact-app.herokuapp.com/export").then(res=>dispatch(exportfilesuccess(fileDownload(res.data,"Contact.csv"))))
