...
import { Postdata, Putdata, Singlegetdata } from "../redux/action"
        ...
        <Box>
          ...
          <div className='content' style={{width:side?"80%":"100%",marginLeft:side?"340px":"0px"}}>
            <div className="uppernew">
              <Box>
              <Img w={'180px'} ml={[14,4,4,8]} borderRadius={"60%"} src={current.image} />                <Input type={"file"} w={"200px"} name="image" onChange={uploadimage}/>
              </Box>
            ...
            <Box  borderBottom={"1px solid #cbcdd4"} mt={'20px'}></Box>
             <Stack p={8} spacing={6}>
                ...
                <Flex>
                    ...
                    <Input onChange={handlechange} ml={"20px"} w={"400px"} h={"30"} type="date" placeholder="Date Of Birth" value={current.DOB} name="DOB"/>
                </Flex>
             </Stack>       
           </div> 
          </Flex>
